...
class ServerlessPlugin {
  constructor(serverless, options) {
    ...
    this.hooks = {
      'after:package:setupProviderConfiguration':  this.compile.bind(this)
    };
  }
  ...
  compile() {
    ...
    this.compileIamRoleStatementsToEventBridge();
  ...
  compileReceiver() {
    const organziationId = this.eventBridgeCrossOrganization.receiveEvents.organizationId;
    ...
    const template = {
      "EventBusPolicyCrossOrganization": {
        ...
        "Properties": {
          ...
          "StatementId": `cross-org-statementId-${organziationId}`,
          "Condition": {
            "Type": "StringEquals",
            "Key": "aws:PrincipalOrgID",
            "Value": organziationId
          }
        }
      }
    };
